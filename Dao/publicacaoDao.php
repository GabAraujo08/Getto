...
class PublicacaoDao
{
    ...
    public static function ListaPublicacaoArtistasEngajados()
    {
        ...
        $consulta = $conexao->prepare('SELECT tbMidia.idTipoMidia, tbUsuario.nicknameUsuario,  tbUsuario.fotoPerfilUsuario, tbPublicacao.descPublicacao, tbMidia.arquivoMidia, TIMESTAMPDIFF(MINUTE, tbPublicacao.horarioPublicacao, NOW()) as minutosPublicacao
                                           FROM tbPublicacao
    ...
    public static function ListaMinhasPublicacao($id)
    {
        ...
        $conexao = Conexao::conectar();
        $consulta = $conexao->prepare('SELECT  tbPublicacao.idPublicacao, tbMidia.idTipoMidia, tbUsuario.nicknameUsuario,  tbUsuario.fotoPerfilUsuario, tbPublicacao.descPublicacao, tbMidia.arquivoMidia, TIMESTAMPDIFF(MINUTE, tbPublicacao.horarioPublicacao, NOW()) as minutosPublicacao FROM tbPublicacao
                                               INNER JOIN tbArtista ON tbArtista.idArtista = tbPublicacao.idArtista
                                               INNER JOIN tbUsuario ON tbUsuario.idUsuario = tbArtista.idUsuario
                                               INNER JOIN tbMidiaPublicacao ON tbMidiaPublicacao.idPublicacao = tbPublicacao.idPublicacao
                                               INNER JOIN tbMidia ON tbMidiaPublicacao.idMidia = tbMidia.idMidia
