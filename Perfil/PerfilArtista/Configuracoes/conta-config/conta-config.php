        ...
        <div class="lista-itens-config">
            <ul class="lista-config">
                ...
                <a href="dashArtista.php">
                    <li class="item-config"><img src="../assets/img/diagrama2.svg" alt="">
                        <h1>Dashboard do artista</h1><img src="../assets/img/icon-seta.svg" alt="">
                    </li>
                </a>
                <li class="item-config" data-bs-toggle="modal" data-bs-target="#modalExcluirConta">
                    <img src="../assets/img/icon-excluir.svg" alt="">
